 ...
 public class PartialSolution{
   ...
   */
   ...
   /**
      ...
      @return one ACCEPT,ABANDON,CONTINUE
   */
   public int examine(){
   ...
   /**
      Yields allextension fo this partial solution.
      @return an array of partial solutions tha extend this solution.
   */
   ...
   public String toString(){
      return Arrays.toString(queens); //No se porque no 
   }
 }